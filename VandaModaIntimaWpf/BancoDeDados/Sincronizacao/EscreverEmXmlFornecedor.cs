...
{
    class EscreverEmXmlFornecedor : IEscreverEmXml<Fornecedor>
    {
        public void EscreverEmBinario(EntidadeMySQL<Fornecedor> entidadeMySQL)
        {
            ...
            elementoFantasia.AppendChild(xmlDocument.CreateTextNode(entidadeMySQL.EntidadeSalva.Fantasia));
            elementoEmail.AppendChild(xmlDocument.CreateTextNode(entidadeMySQL.EntidadeSalva.Email));
            ...
            elementoEntidadeSalva.AppendChild(elementoFantasia);
            elementoEntidadeSalva.AppendChild(elementoEmail);
            ...
            xmlDocument.Save($@"EntidadesSalvas\Fornecedor\EntidadeSalva{entidadeMySQL.EntidadeSalva.GetHashCode()}.xml");
        }
    }
}
